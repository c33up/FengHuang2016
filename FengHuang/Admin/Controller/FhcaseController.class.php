...
class FhcaseController extends BaseController {
    ...
    public function add()
    {
        ...
        if (IS_POST) {
            ...
            if (!$model->create()) {
                ...
                //dump($date);
                if ($model->add($date)) {
                    $this->success("添加成功", U('fhcase/index',array('category'=>$cid)));
                } else {
                    $this->error("添加失败");
                }
            } 
        ...
        if (IS_POST) {
            ...
            if (!$model->create()) {
               ...
               if ($model->where($where)->save($date)) {
                    $this->success("更新成功", U('fhcase/index',array('category'=>$category)));
                } else {
                    $this->error("更新失败");
                }       
            }
    ...
    public function delete()
    {
        ...
        if($result){
            $this->success("删除成功", U('fhcase/index',array('category'=>$category)));
        }else{
            $this->error("删除失败");
        }
    }
