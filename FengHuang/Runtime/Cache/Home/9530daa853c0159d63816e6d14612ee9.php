...
<section class="callaction">
	<div class="container">
		<div class="row">
            ...
            <?php if(is_array($article)): foreach($article as $key=>$a): ?><div class="col-md-4 md-margin-bottom-40">
               <img class="img-responsive" src="<?php echo ($a["imageurl"]); ?>" alt="<?php echo ($a["intro"]); ?>">   
              <ul class="list-unstyled">
                 ...
                 <a href="<?php echo U('video/detail',array('id'=>$a['id']));?>" class="link-1"><p class="intro"><?php echo ($a["intro"]); ?></p> </a>       
