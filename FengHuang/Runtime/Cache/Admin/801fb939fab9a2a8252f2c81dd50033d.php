...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="<?php echo U('user/index');?>">用户管理</a> <a href="#" class="current">修改用户密码</a> </div>
    <h1>修改用户密码</h1>
  </div>
