...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="<?php echo U('picture/index',array('category'=>$category));?>" class="tip-bottom"><?php echo ($category); ?>管理</a> <a href="#" class="current">添加<?php echo ($category); ?>图片</a> </div>
