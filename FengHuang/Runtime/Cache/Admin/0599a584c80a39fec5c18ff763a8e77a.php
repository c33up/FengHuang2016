...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="<?php echo U('picture/index');?>" class="tip-bottom">轮播图片管理</a> <a href="#" class="current">添加轮播图片</a> </div>
  <h1>添加轮播图片</h1>
</div>
    ...
    <div class="span10">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo U('picture/add');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="alert alert-warning">上传图片大小：宽:1180px、高:430px</div>
