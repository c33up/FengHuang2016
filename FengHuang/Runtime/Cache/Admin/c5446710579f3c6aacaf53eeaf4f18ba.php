...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('video/index');?>" class="tip-bottom">网络视频管理</a> <a href="#" class="current">添加网络视频</a> </div>
  <h1>网络视频</h1>
</div>
