...
<html lang="en">
    <head>
        ...
        <title>添加视频锦集-上海烽凰文化传播有限公司</title>
...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a>   
            <a href="<?php echo U('video/index');?>" class="tip-bottom">视频锦集管理</a> 
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <form action="<?php echo U('video/add');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                        <input type="datetime-local" name="createDate" value="<?php echo ($time); ?>"/>
                                        </div>
                                    </div>
                                            <div class="control-group">                   
                                            <div class="controls">
