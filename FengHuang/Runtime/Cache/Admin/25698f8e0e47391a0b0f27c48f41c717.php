...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('intro/index',array('category'=>$cid));?>" class="tip-bottom"><?php echo ($category); ?></a> <a href="#" class="current">添加<?php echo ($category); ?></a> </div>
