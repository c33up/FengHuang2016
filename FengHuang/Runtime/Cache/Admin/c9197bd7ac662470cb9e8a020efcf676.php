...
<div id="content">
    ...
    <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="<?php echo U('localvideo/index');?>" class="current">本地视频</a>  <a href="#" class="current">本地视频详情</a></div>
    <h1>本地视频详情</h1>
  </div>
    ...
    <div class="row-fluid">
      <div class="span10">
          ...
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <a href="<?php echo U('localvideo/index');?>" class="btn btn-primary">返回</a>&nbsp&nbsp&nbsp
              <a href="<?php echo U('localvideo/update',array('id'=>$model['id']));?>" class="btn btn-primary">修改</a>&nbsp&nbsp&nbsp
              <a href="<?php echo U('localvideo/delete',array('id'=>$model['id']));?>" class="btn btn-primary">删除</a>
          </div>
          <div class="span10"> 
              <br/>
          </div>
