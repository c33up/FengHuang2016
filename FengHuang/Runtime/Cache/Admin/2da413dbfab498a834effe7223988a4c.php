...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('service/index',array('category'=>$cid));?>" class="tip-bottom"><?php echo ($category); ?></a> <a href="#" class="current">添加<?php echo ($category); ?></a> </div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo U('service/add');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
