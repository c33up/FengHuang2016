...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('intro/index',array('category'=>$model['category']));?>" class="tip-bottom"><?php echo ($model["category"]); ?></a> <a href="#" class="current">修改<?php echo ($model["category"]); ?></a> </div>
