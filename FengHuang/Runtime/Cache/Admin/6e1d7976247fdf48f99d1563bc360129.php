...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>修改<?php echo ($category); ?>-上海烽凰后台管理主页</title>
...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('intro/index',array('category'=>$model['category']));?>" class="tip-bottom"><?php echo ($category); ?></a> <a href="#" class="current">修改<?php echo ($category); ?></a> </div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo U('intro/update');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
