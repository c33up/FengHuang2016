    ...
    <div class="row-fluid">
      <div class="span12">
          ...
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5><?php echo ($category); ?>列表</h5>
              <div class="pull-right">
                    <div id="search">
                        <form action="<?php echo U('service/index');?>" method="post">
        ...
        <?php if(is_array($article)): foreach($article as $key=>$a): ?><tr class="gradeX">
          ...
          <div>
              <div class="pull-left">
                   <a href="<?php echo U('service/add',array('category'=>$cid));?>" class="btn btn-large btn-primary ">添加<?php echo ($category); ?></a>
               </div>
              <div class="pull-right">
                   <?php echo ($page); ?>
              </div>
