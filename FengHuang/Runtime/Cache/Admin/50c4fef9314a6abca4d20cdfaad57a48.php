...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('service/index',array('category'=>$model['category']));?>" class="tip-bottom"><?php echo ($category); ?></a> <a href="#" class="current"><?php echo ($category); ?>详情</a> </div>
    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
           <a href="<?php echo U('service/index',array('category'=>$model['category']));?>" class="btn btn-primary">返回</a>&nbsp&nbsp&nbsp
              <a href="<?php echo U('service/update',array('category'=>$model['category'],'id'=>$model['id']));?>" class="btn btn-primary">修改</a>&nbsp&nbsp&nbsp
              <a href="<?php echo U('service/delete',array('category'=>$model['category'],'id'=>$model['id']));?>" class="btn btn-primary">删除</a>
        </div>
        <div class="span12 widget-content">
            <div class="span10">
                ...
                <p>
                    <?php if($model['ishome'] == 'yes'): ?><label for="normal" class="control-label">已放置首页显示</label><?php endif; ?>
                </p>
                <hr></hr>
            </div>
            <div class="span10">
