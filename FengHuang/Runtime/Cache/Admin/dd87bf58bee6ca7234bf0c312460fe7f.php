...
<div class="container">
        ...
        <ul class="thumbnails thumbnails-1 list-services">
               <?php if(is_array($article)): foreach($article as $key=>$a): ?><li class="span4">
                         <div class="thumbnail thumbnail-1">
                             <a href="<?php echo U('picture/details',array('category'=>$a['category'],'id'=>$a['id']));?>" class="link-1"><img src="<?php echo ($a["imageurl"]); ?>" alt="<?php echo ($a["intro"]); ?>" width="320" height="320"/></a>
                            <section>
                                <a href="<?php echo U('picture/details',array('category'=>$a['category'],'id'=>$a['id']));?>" class="link-1"><?php echo ($a["intro"]); ?></a>
                            </section>
                         </div>
                     <div class="actions">
                         <a href="<?php echo U('picture/update',array('category'=>$a['category'],'id'=>$a['id']));?>">
                            <i class="icon-pencil icon-white"></i>
                        </a>
                         <a href="<?php echo U('picture/delete',array('category'=>$a['category'],'id'=>$a['id']));?>">
