...
<!--sidebar-menu-->
 ...
 <div id="content">
    ...
    <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" class="current">本地视频管理</a> </div>
    <h1>本地视频管理</h1>
  </div>
<div class="container">
          <div class="row">
        <div class="span12">
            <a href="<?php echo U('localvideo/add');?>" class="btn btn-primary">添加本地视频</a>
                          
                <form action="<?php echo U('localvideo/index');?>" method="post"  class="navbar-form pull-right">
        ...
        <ul class="thumbnails">
               <?php if(is_array($video)): foreach($video as $key=>$v): ?><li class="span3">
                         <div class="thumbnail">
                             <a href="<?php echo U('localvideo/details',array('id'=>$v['id']));?>" class="link-1"><img src="<?php echo ($v["imageurl"]); ?>" alt="<?php echo ($v["intro"]); ?>" class="img-responsive"/></a>
                            <section>
                                <a href="<?php echo U('localvideo/details',array('id'=>$v['id']));?>" class="link-1"><?php echo ($v["intro"]); ?></a>
                                <?php if($v['ishome'] == 'yes'): ?><p>已放到首页</p><?php endif; ?>
                            </section>
                         </div>
                     <div class="actions">
                         <a href="<?php echo U('localvideo/update',array('id'=>$v['id']));?>">
                            <i class="icon-pencil icon-white"></i>
                        </a>
                         <a href="<?php echo U('localvideo/delete',array('id'=>$v['id']));?>">
