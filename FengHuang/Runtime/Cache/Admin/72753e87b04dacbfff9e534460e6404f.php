...
<div id="content">
    ...
    <div id="breadcrumb"> <a href="#" title="返回主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="#" class="current">用户管理</a> </div>
    <h1>用户管理</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <?php else: ?>
                     <td class="center"><a href="<?php echo U('user/update',array('id'=>$u['id']));?>">修改密码</a> | <a href="<?php echo U('user/delete',array('id'=>$u['id']));?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td><?php endif; ?>
