...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('localvideo/index');?>" class="tip-bottom">本地视频管理</a> <a href="#" class="current">修改本地视频</a> </div>
  <h1>本地视频</h1>
</div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo U('localvideo/update');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
