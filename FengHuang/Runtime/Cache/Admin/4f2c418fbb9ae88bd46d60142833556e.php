...
<div id="content">
    ...
    <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="#" class="current">联系我们</a> </div>
    <h1>联系方式</h1>
  </div>
          ...
          <div class="widget-content nopadding">
              ...
              <tbody>
                     ...
                     <tr>
                      ...
                      <?php if($count == 0): ?><tr>
                          <td colspan="2">
                            <a href="<?php echo U('contact/add');?>" class="btn btn-large btn-primary ">添加联系方式</a>
                      </td>
                            </tr>
                          <?php else: ?>
                           <tr>
                         <td colspan="2">
                             <a href="<?php echo U('contact/update');?>" class='btn btn-large btn-primary'>修改联系方式</a>
                         </td>
                     </tr><?php endif; ?>
            </tbody>
            </table>
