...
<div id="content">
    ...
    <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="#" class="current"><?php echo ($category); ?></a> </div>
          ...
          <div class="widget-content nopadding">
              ...
              <tbody>
                <?php if($count == 0): ?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('intro/add',array('category'=>$category));?>" class="btn btn-large btn-primary ">添加<?php echo ($category); ?></a>
                        </td>
                    </tr>
                 <?php else: ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo U('intro/update',array('category'=>$article['category'],'id'=>$article['id']));?>" class='btn btn-large btn-primary'>修改<?php echo ($category); ?></a>
                        </td>
                    </tr><?php endif; ?>
            </tbody>
            </table>
