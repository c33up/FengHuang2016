...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('picture/index',array('category'=>$model['category']));?>" class="tip-bottom"><?php echo ($model["category"]); ?>管理</a> <a href="#" class="current">修改<?php echo ($model["category"]); ?>图片</a> </div>
