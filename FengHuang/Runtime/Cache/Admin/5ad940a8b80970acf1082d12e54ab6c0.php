...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('index/index');?>" title="返回主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo U('picture/index');?>" class="tip-bottom">轮播图片管理</a> <a href="#" class="current">修改轮播图片</a> </div>
  <h1>修改轮播图片</h1>
</div>
